...
#include "EDBRHistoPlotter_fakepho.h"
#include "test.C"
...
void loopPlot_fakephoton_signalB(){
...
//  double lumiValue = 10.0; 
  double lumiValue = 5.8;  //12.70;  //5.80  //2.60;  // 4.30;
//	double lumiValue = 2.60;   
...
//    std::string pathToTrees="./making_root_small/outtree/";
	std::string pathToTrees="./making_root_small/outtree_161213/";
...
//	std::string dataLabels[nDATA]={"outSingleMuon_Run2016C_s"};
	std::string dataLabels[nDATA]={"outSingleMuon_Run2016B_s"};
...
//	std::string mcLabels[nMC]={"ST_s","TTG_s","VV_s","ZG_s","TTJets_s","ZJets_s","WJets_s","WG_s"};
	std::string mcLabels[nMC]={"ST_s","TTG_s","VV_s","ZG_s","SingleMuon_Run2016B_s","WG_s"};
//	std::string mcLabels[nMC]={"ST_s","TTG_s","VV_s","ZG_s","SingleMuon_Run2016C_s","WG_s"};
