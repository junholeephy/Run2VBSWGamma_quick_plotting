void make_small_root_ST()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170916/outST.root","READ");
	TFile *fout = new TFile("outST_s.root","RECREATE");
