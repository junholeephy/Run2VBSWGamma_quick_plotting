void make_small_root_VV()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170916/outVV.root","READ");
	TFile *fout = new TFile("outVV_s.root","RECREATE");
