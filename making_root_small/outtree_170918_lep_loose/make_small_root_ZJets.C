void make_small_root_ZJets()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170916/outZJets.root","READ");
	TFile *fout = new TFile("outZJets_s.root","RECREATE");
