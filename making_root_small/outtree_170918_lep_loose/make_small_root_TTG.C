void make_small_root_TTG()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170916/outTTG.root","READ");
	TFile *fout = new TFile("outTTG_s.root","RECREATE");
