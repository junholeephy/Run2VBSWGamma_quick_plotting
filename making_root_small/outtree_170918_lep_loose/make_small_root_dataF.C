void make_small_root_dataF()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170916/outSingleMuon_Run2016F.root","READ");
	TFile *fout = new TFile("outSingleMuon_Run2016F_s.root","RECREATE");
