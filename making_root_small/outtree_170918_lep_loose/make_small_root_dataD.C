void make_small_root_dataD()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170916/outSingleMuon_Run2016D.root","READ");
	TFile *fout = new TFile("outSingleMuon_Run2016D_s.root","RECREATE");
