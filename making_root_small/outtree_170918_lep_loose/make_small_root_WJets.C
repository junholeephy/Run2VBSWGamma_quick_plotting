void make_small_root_WJets()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170916/outWJets.root","READ");
	TFile *fout = new TFile("outWJets_s.root","RECREATE");
