void make_small_root_WZA_sig()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170926/outWZA_sig.root","READ");
	TFile *fout = new TFile("outWZA_sig_s.root","RECREATE");
