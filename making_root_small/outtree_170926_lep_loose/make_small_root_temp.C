void make_small_root_temp()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170926/outVBSWA_signal.root","READ");
	TFile *fout = new TFile("outVBSWA_signal_s.root","RECREATE");
