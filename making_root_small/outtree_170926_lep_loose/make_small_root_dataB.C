void make_small_root_dataB()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170926/outSingleMuon_Run2016B.root","READ");
	TFile *fout = new TFile("outSingleMuon_Run2016B_s.root","RECREATE");
