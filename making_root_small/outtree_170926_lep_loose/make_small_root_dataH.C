void make_small_root_dataH()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170926/outSingleMuon_Run2016H.root","READ");
	TFile *fout = new TFile("outSingleMuon_Run2016H_s.root","RECREATE");
