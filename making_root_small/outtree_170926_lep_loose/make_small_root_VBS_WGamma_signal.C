void make_small_root_VBS_WGamma_signal()
{
	TFile *f = new TFile("/Volumes/ExHard/Run2VBSWGamma_plotting/PKUTree/outtree_170926/outVBS_WGamma_signal.root","READ");
	TFile *fout = new TFile("outVBS_WGamma_signal_s.root","RECREATE");
