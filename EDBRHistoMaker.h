...
/*
	if(		lep==13 &&
			...
			photon_pev==1 &&
			photon_hoe<0.05 &&
			photon_pt>=20 && photon_pt<=400 &&
			(photon_chiso < TMath::Min(0.2*photon_pt,5*3.32)) &&
			(photon_nhiso < TMath::Min(0.2*photon_pt, 5*(1.92+0.014*photon_pt+0.000019*photon_pt*photon_pt)  ))  &&
			(photon_phoiso < TMath::Min(0.2*photon_pt, 5*(0.81+0.0053*photon_pt) ) ) &&
			TMath::Abs(photon_eta)<1.4442 &&
			( photon_chiso > 3.32 || photon_sieie > 0.0102  ) &&
			photon_sieie > 0.004 
	  ) ;
				...
				(photon_nhiso < TMath::Min(0.2*photon_pt, 5*(1.92+0.014*photon_pt+0.000019*photon_pt*photon_pt)  ))  &&
				(photon_phoiso < TMath::Min(0.2*photon_pt, 5*(0.81+0.0053*photon_pt ) ) ) &&
				(photon_phoiso > 0.81+0.0053*photon_pt || photon_nhiso > 1.92 + 0.014*photon_pt + 0.000019*photon_pt*photon_pt) &&
				TMath::Abs(photon_eta)<1.4442 &&
				(photon_chiso < 1.37 && photon_sieie <= 0.0102 ) &&
				photon_sieie > 0.004
			) ;
	else continue;
*/
