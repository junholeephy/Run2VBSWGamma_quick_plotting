...
#include "EDBRHistoMaker_a_D.h"
#include "EDBRHistoMaker_d.h"

void loopPlot_fakephoton_signalD(){
...
//  double lumiValue = 10.0; 
  double lumiValue = 4.3;  //12.70;  //5.80  //2.60;  // 4.30;
//	double lumiValue = 2.50;   
...
//	std::string mcLabels[nMC]={"ST_s","TTG_s","VV_s","ZG_s","TTJets_s","ZJets_s","WJets_s","WG_s"};
	std::string mcLabels[nMC]={"ST_s","TTG_s","VV_s","ZG_s","SingleMuon_Run2016D_s","WG_s"};
