...
void loopPlot_fakephoton_signalCD(){
...
//  double lumiValue = 10.0; 
  double lumiValue = 6.953;  //12.70;  //5.80  //2.60;  // 4.30;
...
//	std::string dataLabels[nDATA]={"outSingleMuon_Run2016C_s"};
	std::string dataLabels[nDATA]={"outSingleMuon_Run2016CD_s"};
...
//	std::string mcLabels[nMC]={"ST_s","TTG_s","VV_s","ZG_s","TTJets_s","ZJets_s","WJets_s","WG_s"};
	std::string mcLabels[nMC]={"ST_s","TTG_s","VV_s","ZG_s","SingleMuon_Run2016CD_s","WG_s"};
