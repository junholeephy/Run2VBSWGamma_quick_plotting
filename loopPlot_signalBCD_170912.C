...
void loopPlot_signalBCD_170912(){
...
//	std::string pathToTrees="./making_root_small/outtree/";
	std::string pathToTrees="./making_root_small/outtree_170912/";
...
//	std::string dataLabels[nDATA]={"outSingleMuon_Run2016BCD_s"};
	...
	std::string dataLabels[nDATA]={"outSingleMuon_Run2016B_s","outSingleMuon_Run2016C_s","outSingleMuon_Run2016D_s"};
