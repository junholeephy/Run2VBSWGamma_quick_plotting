...
//   TBranch		  *b_jet2metPhi;    
  ...
  void printAllHistos3();
  void printAllHistos4();
  void printAllHistos5();
  void printAllHistos6();
  void saveAllHistos(std::string outFileName);
  void saveAllHistos2(std::string outFileName);
  void saveAllHistos3(std::string outFileName);
  void saveAllHistos4(std::string outFileName);
  void saveAllHistos5(std::string outFileName);
  void saveAllHistos6(std::string outFileName);
...
//  double zeppen_1_;
  ...
  // The histograms
  HistoFactory hs, hs2, hs3, hs4, hs5, hs6;
  std::map<std::string,TH1D*> theHistograms;
  std::map<std::string,TH1D*> theHistograms2;
  std::map<std::string,TH1D*> theHistograms3;
  std::map<std::string,TH1D*> theHistograms4;
  std::map<std::string,TH1D*> theHistograms5;
  std::map<std::string,TH1D*> theHistograms6;
  TH2D *hmjmzz; 
  TH1D *hmzzNEW;
};
...
//    hs.setHisto("nVtx", 25, -0.5, 35);
    ...
    hs.setHisto("1Orig_photonet", 5,22,100);
	hs2.setHisto("2_lep_photonet", 5,22,100);
	hs3.setHisto("3lv_photonet", 5,22,100);
	hs4.setHisto("4lvW_photonet", 5,22,100);
	hs5.setHisto("5lvWa_photonet", 5,22,100);
	hs6.setHisto("6lvWaj_photonet", 5,22,100);

//    hs.setHisto("Mjj",20,0,4000);

	hs.setHisto("1Orig_photon_sieie",50,0.004,0.018);
    hs2.setHisto("2_lep_photon_sieie",50,0.004,0.018);
	hs3.setHisto("3lv_photon_sieie",50,0.004,0.018);
	hs4.setHisto("4lvW_photon_sieie",50,0.004,0.018);
	hs5.setHisto("5lvWa_photon_sieie",50,0.004,0.018);
	hs6.setHisto("6lvWaj_photon_sieie",50,0.004,0.018);

	hs.setHisto("1Orig_photoneta", 8,-2.5,2.5);
	hs2.setHisto("2_lep_photoneta", 8,-2.5,2.5);
	hs3.setHisto("3lv_photoneta", 8,-2.5,2.5);
	hs4.setHisto("4lvW_photoneta", 8,-2.5,2.5);
	hs5.setHisto("5lvWa_photoneta", 8,-2.5,2.5);
	hs6.setHisto("6lvWaj_photoneta", 8,-2.5,2.5);

//    hs.setHisto("ptVlepJEC", 25,0,1000);

    hs.setHisto("1Orig_mtVlepJECnew", 30,0,200);
	hs2.setHisto("2_lep_mtVlepJECnew", 30,0,200);
	hs3.setHisto("3lv_mtVlepJECnew", 30,0,200);
	hs4.setHisto("4lvW_mtVlepJECnew", 30,0,200);
	hs5.setHisto("5lvWa_mtVlepJECnew", 30,0,200);
	hs6.setHisto("6lvWaj_mtVlepJECnew", 30,0,200);
...
//	hs.setHisto("photonchiso",20,0,10);
	...
	hs.setHisto("1Orig_ptlep1", 20, 25,200);
	hs2.setHisto("2_lep_ptlep1", 20, 25,200);
	hs3.setHisto("3lv_ptlep1", 20, 25,200);
	hs4.setHisto("4lvW_ptlep1", 20, 25,200);
	hs5.setHisto("5lvWa_ptlep1", 20, 25,200);
	hs6.setHisto("6lvWaj_ptlep1", 20, 25,200);

	hs.setHisto("1Orig_d0vtx",100,-0.5,0.5);
	hs2.setHisto("2_lep_d0vtx",100,-0.5,0.5);
	hs3.setHisto("3lv_d0vtx",100,-0.5,0.5);
	hs4.setHisto("4lvW_d0vtx",100,-0.5,0.5);
	hs5.setHisto("5lvWa_d0vtx",100,-0.5,0.5);
	hs6.setHisto("6lvWaj_d0vtx",100,-0.5,0.5);

	hs.setHisto("1Orig_dzvtx",100,-1,1);
	hs2.setHisto("2_lep_dzvtx",100,-1,1);
	hs3.setHisto("3lv_dzvtx",100,-1,1);
	hs4.setHisto("4lvW_dzvtx",100,-1,1);
	hs5.setHisto("5lvWa_dzvtx",100,-1,1);
	hs6.setHisto("6lvWaj_dzvtx",100,-1,1);

	hs.setHisto("1Orig_muisolation",20,0.0,0.4);
	hs2.setHisto("2_lep_muisolation",20,0.0,0.4);
	hs3.setHisto("3lv_muisolation",20,0.0,0.4);
	hs4.setHisto("4lvW_muisolation",20,0.0,0.4);
	hs5.setHisto("5lvWa_muisolation",20,0.0,0.4);
	hs6.setHisto("6lvWaj_muisolation",20,0.0,0.4);

    hs.setHisto("1Orig_etalep1", 25,-2.5,2.5);
	hs2.setHisto("2_lep_etalep1", 25,-2.5,2.5);
	hs3.setHisto("3lv_etalep1", 25,-2.5,2.5);
	hs4.setHisto("4lvW_etalep1", 25,-2.5,2.5);
	hs5.setHisto("5lvWa_etalep1", 25,-2.5,2.5);
	hs6.setHisto("6lvWaj_etalep1", 25,-2.5,2.5);
...
//	hs.setHisto("photon_pt",25,20,400);
	...
	hs.setHisto("1Orig_jet1eta",25,0,5);
	hs2.setHisto("2_lep_jet1eta",25,0,5);
	hs3.setHisto("3lv_jet1eta",25,0,5);
	hs4.setHisto("4lvW_jet1eta",25,0,5);
	hs5.setHisto("5lvWa_jet1eta",25,0,5);
	hs6.setHisto("6lvWaj_jet1eta",25,0,5);

	hs.setHisto("1Orig_jet2eta",25,0,5);
	hs2.setHisto("2_lep_jet2eta",25,0,5);
	hs3.setHisto("3lv_jet2eta",25,0,5);
	hs4.setHisto("4lvW_jet2eta",25,0,5);
	hs5.setHisto("5lvWa_jet2eta",25,0,5);
	hs6.setHisto("6lvWaj_jet2eta",25,0,5);
...
//	hs.setHisto("phi_jj",20,0,3.2);
	...
	hs.setHisto("1Orig_jet1pt",10,40,200);
	hs2.setHisto("2_lep_jet1pt",10,40,200);
	hs3.setHisto("3lv_jet1pt",10,40,200);
	hs4.setHisto("4lvW_jet1pt",10,40,200);	
	hs5.setHisto("5lvWa_jet1pt",10,40,200);
	hs6.setHisto("6lvWaj_jet1pt",10,40,200);

	hs.setHisto("1Orig_jet2pt",10,30,200);
	hs2.setHisto("2_lep_jet2pt",10,30,200);
	hs3.setHisto("3lv_jet2pt",10,30,200);
	hs4.setHisto("4lvW_jet2pt",10,30,200);
	hs5.setHisto("5lvWa_jet2pt",10,30,200);
	hs6.setHisto("6lvWaj_jet2pt",10,30,200);

    hs.setHisto("1Orig_MET_et",20,0,200);
	hs2.setHisto("2_lep_MET_et",20,0,200);
	hs3.setHisto("3lv_MET_et",20,0,200);
	hs4.setHisto("4lvW_MET_et",20,0,200); 
	hs5.setHisto("5lvWa_MET_et",20,0,200);
	hs6.setHisto("6lvWaj_MET_et",20,0,200);
  ...
  nVars3 = hs3.vars.size();
  nVars4 = hs4.vars.size();
  nVars5 = hs5.vars.size();
  nVars6 = hs6.vars.size();
...
//  histogram->SetMinimum(1.0);
  ...
  for(int i = 0; i!= nVars3; ++i) {
    sprintf(buffer,"%s_mu",hs3.vars[i].c_str());
//    sprintf(buffer,"%s_el",hs.vars[i].c_str());
    sprintf(buffer2,"%s;%s;Number of events;",hs3.vars[i].c_str(),hs3.vars[i].c_str());
//    if(i != 20)
        TH1D* histogram = new TH1D(buffer,
                   buffer2,
                   hs3.nBins[i],
...
//  histogram->SetMinimum(1.0);
    ...
    histogram->SetDirectory(0);
    histogram->Sumw2();
    theHistograms3[hs3.vars[i]] = histogram;
  }

  for(int i = 0; i!= nVars4; ++i) {
    sprintf(buffer,"%s_mu",hs4.vars[i].c_str());
//    sprintf(buffer,"%s_el",hs.vars[i].c_str());
    sprintf(buffer2,"%s;%s;Number of events;",hs4.vars[i].c_str(),hs4.vars[i].c_str());
//    if(i != 20)
        TH1D* histogram = new TH1D(buffer,
                   buffer2,
                   hs4.nBins[i],
...
//  histogram->SetMinimum(1.0);
    ...
    histogram->SetDirectory(0);
    histogram->Sumw2();
    theHistograms4[hs4.vars[i]] = histogram;
  }

  for(int i = 0; i!= nVars5; ++i) {
    sprintf(buffer,"%s_mu",hs5.vars[i].c_str());
//    sprintf(buffer,"%s_el",hs.vars[i].c_str());
    sprintf(buffer2,"%s;%s;Number of events;",hs5.vars[i].c_str(),hs5.vars[i].c_str());
//    if(i != 20)
        TH1D* histogram = new TH1D(buffer,
                   buffer2,
                   hs5.nBins[i],
...
//  histogram->SetMinimum(1.0);
    ...
    histogram->SetDirectory(0);
    histogram->Sumw2();
    theHistograms5[hs5.vars[i]] = histogram;
  }

  for(int i = 0; i!= nVars6; ++i) {
    sprintf(buffer,"%s_mu",hs6.vars[i].c_str());
//    sprintf(buffer,"%s_el",hs.vars[i].c_str());
    sprintf(buffer2,"%s;%s;Number of events;",hs6.vars[i].c_str(),hs6.vars[i].c_str());
//    if(i != 20)
        TH1D* histogram = new TH1D(buffer,
                   buffer2,
                   hs6.nBins[i],
...
//  histogram->SetMinimum(1.0);
    ...
    histogram->SetDirectory(0);
    histogram->Sumw2();
    theHistograms6[hs6.vars[i]] = histogram;
  }
...
void EDBRHistoMaker::printAllHistos3() {
  printf("We have %i histograms \n",int(theHistograms3.size()));
  typedef std::map<std::string, TH1D*>::iterator it_type;
  for(it_type iterator = theHistograms3.begin(); iterator != theHistograms3.end(); iterator++) {
    //iterator->second->Print();
    // Repeat if you also want to iterate through the second map.
  }
}

void EDBRHistoMaker::printAllHistos4() {
  printf("We have %i histograms \n",int(theHistograms4.size()));
  typedef std::map<std::string, TH1D*>::iterator it_type;
  for(it_type iterator = theHistograms4.begin(); iterator != theHistograms4.end(); iterator++) {
    //iterator->second->Print();
    // Repeat if you also want to iterate through the second map.
  }
}

void EDBRHistoMaker::printAllHistos5() {
  printf("We have %i histograms \n",int(theHistograms5.size()));
  typedef std::map<std::string, TH1D*>::iterator it_type;
  for(it_type iterator = theHistograms5.begin(); iterator != theHistograms5.end(); iterator++) {
    //iterator->second->Print();
    // Repeat if you also want to iterate through the second map.
  }
}

void EDBRHistoMaker::printAllHistos6() {
  printf("We have %i histograms \n",int(theHistograms6.size()));
  typedef std::map<std::string, TH1D*>::iterator it_type;
  for(it_type iterator = theHistograms6.begin(); iterator != theHistograms6.end(); iterator++) {
    //iterator->second->Print();
    // Repeat if you also want to iterate through the second map.
  }
}
...
void EDBRHistoMaker::saveAllHistos2(std::string outFileName) {
  TString na2 = "2";
  TFile* outFile = TFile::Open(na2+outFileName.c_str(),"RECREATE");
...
void EDBRHistoMaker::saveAllHistos3(std::string outFileName) {
  TFile* outFile = TFile::Open(outFileName.c_str(),"RECREATE");

  for(int i = 0; i!=nVars3; ++i) {
    std::string name = hs3.vars[i];
    const TH1D* thisHisto = this->theHistograms3[name];
    thisHisto->Write();
  }
  outFile->Close();
}

void EDBRHistoMaker::saveAllHistos4(std::string outFileName) {

  TFile* outFile = TFile::Open(outFileName.c_str(),"RECREATE");

  for(int i = 0; i!=nVars4; ++i) {
    std::string name = hs4.vars[i];
    const TH1D* thisHisto = this->theHistograms4[name];
    thisHisto->Write();
  }
  outFile->Close();
}

void EDBRHistoMaker::saveAllHistos5(std::string outFileName) {

  TFile* outFile = TFile::Open(outFileName.c_str(),"RECREATE");

  for(int i = 0; i!=nVars5; ++i) {
    std::string name = hs5.vars[i];
    const TH1D* thisHisto = this->theHistograms5[name];
    thisHisto->Write();
  }
  outFile->Close();
}

void EDBRHistoMaker::saveAllHistos6(std::string outFileName) {

  TFile* outFile = TFile::Open(outFileName.c_str(),"RECREATE");

  for(int i = 0; i!=nVars6; ++i) {
    std::string name = hs6.vars[i];
    const TH1D* thisHisto = this->theHistograms6[name];
    thisHisto->Write();
  }
  outFile->Close();
}
...
///////////11111111//////////
		if(lep==13 && nlooseeles==0 && nloosemus<2 && HLT_Mu3 ==1 && fabs(muisolation)<0.15) //;
		{
            int iswjets = 0;
            int isnotwets = 0;
            int iszjets = 0;
...
//    (theHistograms["nVtx"])->Fill(nVtx,actualWeight);
      (theHistograms["1Orig_photonet"])->Fill(photonet,actualWeight);
 //     (theHistograms["Mjj"])->Fill(Mjj,actualWeight);
      (theHistograms["1Orig_photon_sieie"])->Fill(photon_sieie,actualWeight);
      (theHistograms["1Orig_photoneta"])->Fill(photoneta,actualWeight);
//    (theHistograms["ptVlepJEC"])->Fill(ptVlepJEC,actualWeight);
      (theHistograms["1Orig_mtVlepJECnew"])->Fill(mtVlepJECnew,actualWeight);
...
//    (theHistograms["photonchiso"])->Fill(photonchiso,actualWeight);
      (theHistograms["1Orig_ptlep1"])->Fill(ptlep1,actualWeight);
      (theHistograms["1Orig_d0vtx"])->Fill(d0vtx,actualWeight);
      (theHistograms["1Orig_dzvtx"])->Fill(dzvtx,actualWeight);
      (theHistograms["1Orig_muisolation"])->Fill(muisolation,actualWeight);
      (theHistograms["1Orig_etalep1"])->Fill(etalep1,actualWeight);
//////
...
//      (theHistograms["photon_pt"])->Fill(photon_pt[0],actualWeight);
      (theHistograms["1Orig_jet1pt"])->Fill(jet1pt,actualWeight);
      (theHistograms["1Orig_jet2pt"])->Fill(jet2pt,actualWeight);
      (theHistograms["1Orig_jet1eta"])->Fill(jet1eta,actualWeight);
      (theHistograms["1Orig_jet2eta"])->Fill(jet2eta,actualWeight);
...
//    (theHistograms["phi_jj"])->Fill(phijj,actualWeight);
    //  (theHistograms["philep1"])->Fill(philep1,actualWeight);
      (theHistograms["1Orig_MET_et"])->Fill(MET_et,actualWeight);
    } else;
	} else continue;
...
//////////222222222//////////
            ...
            if (isnotwets>0 || iswjets>0 || iszjets>0 || isttjets>0) {		
//    (theHistograms["nVtx"])->Fill(nVtx,actualWeight);
      (theHistograms2["2_lep_photonet"])->Fill(photonet,actualWeight);
 //     (theHistograms["Mjj"])->Fill(Mjj,actualWeight);
      (theHistograms2["2_lep_photon_sieie"])->Fill(photon_sieie,actualWeight);
      (theHistograms2["2_lep_photoneta"])->Fill(photoneta,actualWeight);
//    (theHistograms["ptVlepJEC"])->Fill(ptVlepJEC,actualWeight);
      (theHistograms2["2_lep_mtVlepJECnew"])->Fill(mtVlepJECnew,actualWeight);
//      (theHistograms["photonsieie"])->Fill(photonsieie,actualWeight);
//      (theHistograms["photonphoiso"])->Fill(photonphoiso,actualWeight);
//    (theHistograms["photonchiso"])->Fill(photonchiso,actualWeight);
      (theHistograms2["2_lep_ptlep1"])->Fill(ptlep1,actualWeight);
      (theHistograms2["2_lep_d0vtx"])->Fill(d0vtx,actualWeight);
      (theHistograms2["2_lep_dzvtx"])->Fill(dzvtx,actualWeight);
      (theHistograms2["2_lep_muisolation"])->Fill(muisolation,actualWeight);
      (theHistograms2["2_lep_etalep1"])->Fill(etalep1,actualWeight);
//////
//    (theHistograms["zepp"])->Fill(zepp,actualWeight);         //zepp
//    (theHistograms["photonphi"])->Fill(photonphi,actualWeight);//photonphi
//      (theHistograms["photon_pt"])->Fill(photon_pt[0],actualWeight);
      (theHistograms2["2_lep_jet1pt"])->Fill(jet1pt,actualWeight);
      (theHistograms2["2_lep_jet2pt"])->Fill(jet2pt,actualWeight);
      (theHistograms2["2_lep_jet1eta"])->Fill(jet1eta,actualWeight);
      (theHistograms2["2_lep_jet2eta"])->Fill(jet2eta,actualWeight);
//    (theHistograms["jet1phi"])->Fill(jet1phi,actualWeight);
//    (theHistograms["jet2phi"])->Fill(jet2phi,actualWeight); 
//    (theHistograms["MET_et"])->Fill(MET_et,actualWeight);
//  double etajj=jet2eta-jet1eta; if((etajj)<0) etajj=-etajj;  
...
//    (theHistograms["phi_jj"])->Fill(phijj,actualWeight);
    //  (theHistograms["philep1"])->Fill(philep1,actualWeight);
      (theHistograms2["2_lep_MET_et"])->Fill(MET_et,actualWeight);
	 } else;
	} else continue;
/*
////////////33333333333//////////
            ...
            if (isnotwets>0 || iswjets>0 || iszjets>0 || isttjets>0) {
//    (theHistograms["nVtx"])->Fill(nVtx,actualWeight);
      (theHistograms3["3lv_photonet"])->Fill(photonet,actualWeight);
 //     (theHistograms["Mjj"])->Fill(Mjj,actualWeight);
      (theHistograms3["3lv_photon_sieie"])->Fill(photon_sieie,actualWeight);
      (theHistograms3["3lv_photoneta"])->Fill(photoneta,actualWeight);
//    (theHistograms["ptVlepJEC"])->Fill(ptVlepJEC,actualWeight);
      (theHistograms3["3lv_mtVlepJECnew"])->Fill(mtVlepJECnew,actualWeight);
//      (theHistograms["photonsieie"])->Fill(photonsieie,actualWeight);
//      (theHistograms["photonphoiso"])->Fill(photonphoiso,actualWeight);
//    (theHistograms["photonchiso"])->Fill(photonchiso,actualWeight);
      (theHistograms3["3lv_ptlep1"])->Fill(ptlep1,actualWeight);
      (theHistograms3["3lv_d0vtx"])->Fill(d0vtx,actualWeight);
      (theHistograms3["3lv_dzvtx"])->Fill(dzvtx,actualWeight);
      (theHistograms3["3lv_muisolation"])->Fill(muisolation,actualWeight);
      (theHistograms3["3lv_etalep1"])->Fill(etalep1,actualWeight);
//////
//    (theHistograms["zepp"])->Fill(zepp,actualWeight);         //zepp
//    (theHistograms["photonphi"])->Fill(photonphi,actualWeight);//photonphi
//      (theHistograms["photon_pt"])->Fill(photon_pt[0],actualWeight);
      (theHistograms3["3lv_jet1pt"])->Fill(jet1pt,actualWeight);
      (theHistograms3["3lv_jet2pt"])->Fill(jet2pt,actualWeight);
      (theHistograms3["3lv_jet1eta"])->Fill(jet1eta,actualWeight);
      (theHistograms3["3lv_jet2eta"])->Fill(jet2eta,actualWeight);
//    (theHistograms["jet1phi"])->Fill(jet1phi,actualWeight);
//    (theHistograms["jet2phi"])->Fill(jet2phi,actualWeight); 
//    (theHistograms["MET_et"])->Fill(MET_et,actualWeight);
//  double etajj=jet2eta-jet1eta; if((etajj)<0) etajj=-etajj;  
...
//    (theHistograms["phi_jj"])->Fill(phijj,actualWeight);
    //  (theHistograms["philep1"])->Fill(philep1,actualWeight);
      (theHistograms3["3lv_MET_et"])->Fill(MET_et,actualWeight);
	} else;
	} else continue;
...
//////////////4444444444444444//////////////////
            ...
            if (isnotwets>0 || iswjets>0 || iszjets>0 || isttjets>0) {	
//    (theHistograms["nVtx"])->Fill(nVtx,actualWeight);
      (theHistograms4["4lvW_photonet"])->Fill(photonet,actualWeight);
 //     (theHistograms["Mjj"])->Fill(Mjj,actualWeight);
      (theHistograms4["4lvW_photon_sieie"])->Fill(photon_sieie,actualWeight);
      (theHistograms4["4lvW_photoneta"])->Fill(photoneta,actualWeight);
//    (theHistograms["ptVlepJEC"])->Fill(ptVlepJEC,actualWeight);
      (theHistograms4["4lvW_mtVlepJECnew"])->Fill(mtVlepJECnew,actualWeight);
//      (theHistograms["photonsieie"])->Fill(photonsieie,actualWeight);
//      (theHistograms["photonphoiso"])->Fill(photonphoiso,actualWeight);
//    (theHistograms["photonchiso"])->Fill(photonchiso,actualWeight);
      (theHistograms4["4lvW_ptlep1"])->Fill(ptlep1,actualWeight);
      (theHistograms4["4lvW_d0vtx"])->Fill(d0vtx,actualWeight);
      (theHistograms4["4lvW_dzvtx"])->Fill(dzvtx,actualWeight);
      (theHistograms4["4lvW_muisolation"])->Fill(muisolation,actualWeight);
      (theHistograms4["4lvW_etalep1"])->Fill(etalep1,actualWeight);
//////
//    (theHistograms["zepp"])->Fill(zepp,actualWeight);         //zepp
//    (theHistograms["photonphi"])->Fill(photonphi,actualWeight);//photonphi
//      (theHistograms["photon_pt"])->Fill(photon_pt[0],actualWeight);
      (theHistograms4["4lvW_jet1pt"])->Fill(jet1pt,actualWeight);
      (theHistograms4["4lvW_jet2pt"])->Fill(jet2pt,actualWeight);
      (theHistograms4["4lvW_jet1eta"])->Fill(jet1eta,actualWeight);
      (theHistograms4["4lvW_jet2eta"])->Fill(jet2eta,actualWeight);
//    (theHistograms["jet1phi"])->Fill(jet1phi,actualWeight);
//    (theHistograms["jet2phi"])->Fill(jet2phi,actualWeight); 
//    (theHistograms["MET_et"])->Fill(MET_et,actualWeight);
//  double etajj=jet2eta-jet1eta; if((etajj)<0) etajj=-etajj;  
...
//    (theHistograms["phi_jj"])->Fill(phijj,actualWeight);
    //  (theHistograms["philep1"])->Fill(philep1,actualWeight);
      (theHistograms4["4lvW_MET_et"])->Fill(MET_et,actualWeight);
	} else;
	} else continue;

///////////////////55555555555555555/////////////////
						if(photonet>22 && fabs(photoneta)<1.44)
						{
            int iswjets = 0;
            int isnotwets = 0;
            int iszjets = 0;
            ...
            if (isnotwets>0 || iswjets>0 || iszjets>0 || isttjets>0) {
//    (theHistograms["nVtx"])->Fill(nVtx,actualWeight);
      (theHistograms5["5lvWa_photonet"])->Fill(photonet,actualWeight);
 //     (theHistograms["Mjj"])->Fill(Mjj,actualWeight);
      (theHistograms5["5lvWa_photon_sieie"])->Fill(photon_sieie,actualWeight);
      (theHistograms5["5lvWa_photoneta"])->Fill(photoneta,actualWeight);
//    (theHistograms["ptVlepJEC"])->Fill(ptVlepJEC,actualWeight);
      (theHistograms5["5lvWa_mtVlepJECnew"])->Fill(mtVlepJECnew,actualWeight);
//      (theHistograms["photonsieie"])->Fill(photonsieie,actualWeight);
//      (theHistograms["photonphoiso"])->Fill(photonphoiso,actualWeight);
//    (theHistograms["photonchiso"])->Fill(photonchiso,actualWeight);
      (theHistograms5["5lvWa_ptlep1"])->Fill(ptlep1,actualWeight);
      (theHistograms5["5lvWa_d0vtx"])->Fill(d0vtx,actualWeight);
      (theHistograms5["5lvWa_dzvtx"])->Fill(dzvtx,actualWeight);
      (theHistograms5["5lvWa_muisolation"])->Fill(muisolation,actualWeight);
      (theHistograms5["5lvWa_etalep1"])->Fill(etalep1,actualWeight);
//////
//    (theHistograms["zepp"])->Fill(zepp,actualWeight);         //zepp
//    (theHistograms["photonphi"])->Fill(photonphi,actualWeight);//photonphi
//      (theHistograms["photon_pt"])->Fill(photon_pt[0],actualWeight);
      (theHistograms5["5lvWa_jet1pt"])->Fill(jet1pt,actualWeight);
      (theHistograms5["5lvWa_jet2pt"])->Fill(jet2pt,actualWeight);
      (theHistograms5["5lvWa_jet1eta"])->Fill(jet1eta,actualWeight);
      (theHistograms5["5lvWa_jet2eta"])->Fill(jet2eta,actualWeight);
//    (theHistograms["jet1phi"])->Fill(jet1phi,actualWeight);
//    (theHistograms["jet2phi"])->Fill(jet2phi,actualWeight); 
//    (theHistograms["MET_et"])->Fill(MET_et,actualWeight);
//  double etajj=jet2eta-jet1eta; if((etajj)<0) etajj=-etajj;  
...
//    (theHistograms["phi_jj"])->Fill(phijj,actualWeight);
    //  (theHistograms["philep1"])->Fill(philep1,actualWeight);
      (theHistograms5["5lvWa_MET_et"])->Fill(MET_et,actualWeight);
	} else;
	}else continue;

//////////////////////////666666666666666//////////////////
							if(jet1pt>40 && jet2pt>30 && abs(jet1eta)<4.7 && abs(jet2eta)<4.7)
							{
            int iswjets = 0;
            int isnotwets = 0;
            int iszjets = 0;
            ...
            if (isnotwets>0 || iswjets>0 || iszjets>0 || isttjets>0) {
//    (theHistograms["nVtx"])->Fill(nVtx,actualWeight);
      (theHistograms6["6lvWaj_photonet"])->Fill(photonet,actualWeight);
 //     (theHistograms["Mjj"])->Fill(Mjj,actualWeight);
      (theHistograms6["6lvWaj_photon_sieie"])->Fill(photon_sieie,actualWeight);
      (theHistograms6["6lvWaj_photoneta"])->Fill(photoneta,actualWeight);
//    (theHistograms["ptVlepJEC"])->Fill(ptVlepJEC,actualWeight);
      (theHistograms6["6lvWaj_mtVlepJECnew"])->Fill(mtVlepJECnew,actualWeight);
//      (theHistograms["photonsieie"])->Fill(photonsieie,actualWeight);
//      (theHistograms["photonphoiso"])->Fill(photonphoiso,actualWeight);
//    (theHistograms["photonchiso"])->Fill(photonchiso,actualWeight);
      (theHistograms6["6lvWaj_ptlep1"])->Fill(ptlep1,actualWeight);
      (theHistograms6["6lvWaj_d0vtx"])->Fill(d0vtx,actualWeight);
      (theHistograms6["6lvWaj_dzvtx"])->Fill(dzvtx,actualWeight);
      (theHistograms6["6lvWaj_muisolation"])->Fill(muisolation,actualWeight);
      (theHistograms6["6lvWaj_etalep1"])->Fill(etalep1,actualWeight);
//////
//    (theHistograms["zepp"])->Fill(zepp,actualWeight);         //zepp
//    (theHistograms["photonphi"])->Fill(photonphi,actualWeight);//photonphi
//      (theHistograms["photon_pt"])->Fill(photon_pt[0],actualWeight);
      (theHistograms6["6lvWaj_jet1pt"])->Fill(jet1pt,actualWeight);
      (theHistograms6["6lvWaj_jet2pt"])->Fill(jet2pt,actualWeight);
      (theHistograms6["6lvWaj_jet1eta"])->Fill(jet1eta,actualWeight);
      (theHistograms6["6lvWaj_jet2eta"])->Fill(jet2eta,actualWeight);
//    (theHistograms["jet1phi"])->Fill(jet1phi,actualWeight);
//    (theHistograms["jet2phi"])->Fill(jet2phi,actualWeight); 
//    (theHistograms["MET_et"])->Fill(MET_et,actualWeight);
//  double etajj=jet2eta-jet1eta; if((etajj)<0) etajj=-etajj;  
...
//    (theHistograms["phi_jj"])->Fill(phijj,actualWeight);
    //  (theHistograms["philep1"])->Fill(philep1,actualWeight);
      (theHistograms6["6lvWaj_MET_et"])->Fill(MET_et,actualWeight);
	}else;
	}else continue;
*/
	}
...
//  this->saveAllHistos3(outFileName);
//  this->saveAllHistos4(outFileName);
//  this->saveAllHistos5(outFileName);
//  this->saveAllHistos6(outFileName);
}
