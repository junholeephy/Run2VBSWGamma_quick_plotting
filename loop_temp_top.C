...
//  double lumiValue = 10.0; 
  ...
  /// Path to wherever the files with the trees are. 
    std::string pathToTrees="../PKUTree/outtree/";
...
//  const int nMC=8;
  const int nMC=1;
//	std::string mcLabels[nMC]={"ST","TTA","TTJets","VV","ZJets","ZA","WJets","WA"};
    std::string mcLabels[nMC]={"Top"};
...
std::string mcLabelsSig[nMCSig]={"outsignal_160427"};
