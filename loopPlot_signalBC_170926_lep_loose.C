...
void loopPlot_signalBC_170926_lep_loose(){
...
//	bool dopileupreweight = true;	
  ...
  /// Path to wherever the files with the trees are. 
	std::string pathToTrees="./making_root_small/outtree_170926_lep_loose/";
  ...
  const int nDATA=2;//set to zero if you don't want to plot
	...
	std::string dataLabels[nDATA]={"outSingleMuon_Run2016B_s","outSingleMuon_Run2016C_s"};
