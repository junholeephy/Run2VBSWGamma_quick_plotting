...
//	if(i==4) {leg->AddEntry(histosMC.at(i), "TTJets_s", "f"); continue; }
//	if(i==5) {leg->AddEntry(histosMC.at(i), "ZJets_s", "f"); continue; }
	if(i==4) {leg->AddEntry(histosMC.at(i), "Fake photon", "f"); continue; }
//	if(i==6) {leg->AddEntry(histosMC.at(i), "WJets_s", "f"); continue; }
	if(i==5) {leg->AddEntry(histosMC.at(i), "WG_s", "f"); continue; }
	}
...
//	CMS_lumi(fPads1,4,0, "5.80");
	CMS_lumi(fPads1,4,0, "12.70");
// Save the picture
  char buffer[256];
  cv->SetLogy(false);
